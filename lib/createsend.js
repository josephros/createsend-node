...
function CreateSend (auth, options) {
    ...
    var result = {
        ...
        requestWasRateLimited: function (res) {
            return res.headers['X-RateLimit-Remaining'] === 0 ? true : false;
        },
        getRateLimitData: function (res) {
            return {
                limited: this.requestWasRateLimited(res),
